...
# from dagster_slurm.ssh_helpers import TERMINAL_STATES, scp_put, ssh_check, ssh_job_state
...
#             remote_run_dir,
#             "-o",
#             f"{remote_run_dir}/slurm-%j.out",
#             "-e",
#             f"{remote_run_dir}/slurm-%j.err",
#             "-t",
#             TIME_LIMIT,
#             "-c",
#             CPUS,
...
#             + f" {shlex.quote(remote_run_dir)}/job.sbatch"
#         )
